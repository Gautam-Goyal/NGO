...
class _HomePageState extends State<HomePage> {
  ...
  //   await Fluttertoast.showToast(msg: _prefs.getString('userType')!);
  // }
  ...
  showSheet(id, lat, long, name, address, workingIn, double startLat,
      double startLng, mobile, email, website,documentID) {
    showModalBottomSheet(
      shape: const RoundedRectangleBorder(
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(30),
  ...
  addNgoMarker(
      id, lat, long, name, address, marker, workingIn, mobile, email, website,documentID) {
    return Marker(
      onTap: () {
        showSheet(id, lat, long, name, address, workingIn, startLat, startLng,
            mobile, email, website,documentID);
      },
